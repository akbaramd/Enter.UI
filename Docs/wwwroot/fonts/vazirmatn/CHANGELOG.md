...
- Fixed technical problems in outputs by completely changing the way of combining with Latin and the way of producing
  outputs (scripts have been rewritten)
...
برای مشاهده تاریخچه فونت وزیر به [این صفحه](https://github.com/rastikerdar/vazir-font/blob/master/CHANGELOG.md) مراجعه
نمایید.
