...
public class EntToastOptions
{
    ...
    public EntToastOptions(
        ...
        int extendedTimeout,
        EntToastPosition? toastPosition)
    {
        ...
        {
            AdditionalClasses += " ent-toast-action";
        }
    }

#pragma warning disable CS8618
    internal EntToastOptions() { }
