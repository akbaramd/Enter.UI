...
public interface IEntToastService
{
    ...
    /// </summary>
    event Action<EntToastLevel, RenderFragment, Action<EntToastOptions>?> OnShow;
    ...
    /// </summary>
    event Action<EntToastLevel>? OnClearToasts;
    ...
    /// </summary>
    event Action<Type, ToastParameters?, Action<EntToastOptions>?>? OnShowComponent;
    ...
    /// </summary>
    event Action<EntToastLevel>? OnClearQueueToasts;
    ...
    void ShowInfo(string message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowInfo(RenderFragment message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">Text to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowSuccess(string message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">RenderFragment to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowSuccess(RenderFragment message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">Text to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowWarning(string message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">RenderFragment to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowWarning(RenderFragment message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">Text to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowError(string message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">RenderFragment to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowError(RenderFragment message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">Text to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowToast(EntToastLevel level, string message, Action<EntToastOptions>? settings = null);
    ...
    /// <param name="message">RenderFragment to display on the toast</param>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowToast(EntToastLevel level, RenderFragment message, Action<EntToastOptions>? settings = null);
    ...
    /// </summary>
    /// <param name="settings">Settings to configure the toast instance</param>
    void ShowToast<TComponent>(Action<EntToastOptions> settings) where TComponent : IComponent;
    ...
    /// <param name="parameters">Key/Value collection of parameters to pass to component being displayed</param>
    /// /// <param name="settings">Settings to configure the toast instance</param>
    void ShowToast<TComponent>(ToastParameters parameters, Action<EntToastOptions> settings) where TComponent : IComponent;
    ...
    /// </summary>
    void ClearToasts(EntToastLevel entToastLevel);
    ...
    /// </summary>
    void ClearQueueToasts(EntToastLevel entToastLevel);
